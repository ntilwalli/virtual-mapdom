...
test("render map", assert => {
  ...
  const vdom = new VNode('map', {anchorElement: element2, centerZoom: {zoom: 7, center: [4, 5]}, maxBounds: {sw: [1,2], ne: [3,5]}, disablePanZoom: true, attributes: {class: `randCN`, id: `someid`}})
